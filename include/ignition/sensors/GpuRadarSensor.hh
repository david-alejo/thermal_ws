 ...
 *
*/
#ifndef IGNITION_SENSORS_GPURADARSENSOR_HH_
#define IGNITION_SENSORS_GPURADARSENSOR_HH_
...
#include "ignition/sensors/gpu_radar/Export.hh"
...
namespace ignition
{
  namespace sensors
  {
    ...
    class GpuRadarSensorPrivate;

    /// \brief GpuRadar Sensor Class
    ///
    ...
    class IGNITION_SENSORS_GPU_RADAR_VISIBLE GpuRadarSensor : public Radar
    {
      /// \brief constructor
      public: GpuRadarSensor();

      /// \brief destructor
      public: virtual ~GpuRadarSensor();
      ...
      /// \brief Create Radar sensor
      public: virtual bool CreateRadar() override;
      ...
      public: virtual ignition::common::ConnectionPtr ConnectNewRadarFrame(
      ...
      /// \internal
      private: std::unique_ptr<GpuRadarSensorPrivate> dataPtr;
