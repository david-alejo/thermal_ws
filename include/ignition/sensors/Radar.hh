 ...
 *
*/
#ifndef IGNITION_SENSORS_RADAR_HH_
#define IGNITION_SENSORS_RADAR_HH_
...
#include "ignition/sensors/radar/Export.hh"
...
namespace ignition
{
  namespace sensors
  {
    ...
    class IGNITION_SENSORS_RADAR_VISIBLE Radar : public RenderingSensor
    {
      /// \brief constructor
      public: Radar();

      /// \brief destructor
      public: virtual ~Radar();
      ...
      /// configured. This should be called before PublishRadarScan if you
      ...
      /// \param[in] _now The current time
      /// \return true if the update was successfull
      public: virtual bool PublishRadarScan(
      ...
      public: virtual bool CreateRadar();
      ...
      public: mutable std::mutex radarMutex;
      ...
      /// \internal
      private: std::unique_ptr<RadarPrivate> dataPtr;
      IGN_COMMON_WARN_RESUME__DLL_INTERFACE_MISSING
    };
    }
  }
